...
<script type="text/javascript">
	$(function() {
		...
		var totalRows = 24; // Tổng số sản phẩm hiển thị
				...
				<div class="col-lg-12 text-center">
					<div class="breadcrumb__text">
						...
						<div class="breadcrumb__option">
							<a href="home">Trang chủ</a> <span>Cửa Hàng</span>
						</div>
					</div>
				</div>
			</div>
									...
									<div class="product__item">
										...
										<div class="product__item__text">
											...
											<c:if test="${a.salePrice > 0 }">
												<h5>
													<span style="text-decoration: line-through;"><fmt:formatNumber
															value="${a.price}" type="NUMBER" /></span> <br> <span
